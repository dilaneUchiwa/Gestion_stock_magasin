@extends('layouts/navigation.consultationbar', ['page' => 'famille'])
                    ...
                    <div class="card ">
                        <div class="card-header">
                                <div class="col text-align-center">
                                    <h4 class="card-title black">LISTE DES FAMILLES DE PRODUITS</h4>
                                </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        @foreach ($familles as $cat)
                                            <tr>
                                                ...
                                                <td class="td-actions text-align-center">
                                                    ...
                                                    <a href="{{ route('famille.edit', $cat->id_famille) }}"
                                                        class="btn btn-link" data-toggle="tooltip" data-placement="bottom"
                                                        title="Modifier ">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('famille.destroy', $cat->id_famille ) }}"
